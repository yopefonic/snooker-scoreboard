describe("ssb.Frame", function() {
    ...
    describe("endFrame", function() {
        describe("when the frame has a winner", function() {
            beforeEach(function (){
                frame.scores = [
                    [2],
                    [1]
            ...
            it("should set ended to true", function() {
                frame.endFrame();
                expect(frame.ended).toBeTruthy();
            });

            it("should return true", function() {
                expect(frame.endFrame()).toBeTruthy();
            });
        });

        describe("when the frame does not have a winner", function() {
            beforeEach(function (){
                frame.scores = [
                    [1],
                    [1]
            ...
            it("should not set ended to true", function() {
                frame.endFrame();
                expect(frame.ended).toBeFalsy();
            });

            it("should return false", function() {
                expect(frame.endFrame()).toBeFalsy();
            });
        });
    });
});